...
export default function NavBar() {
    const title = 'NFL Pulse'
    // TODO implement useState to handle onCLick operation on menu click
    return (
        <nav className="bg-white border-gray-200 dark:bg-gray-700">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link href="/" className="flex items-center space-x-4 rtl:space-x-reverse">
                    <img src="/NFLPulseLogo.png" className="h-[60px]" alt="NFL Pulse Logo" />
                ...
                </button>                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
